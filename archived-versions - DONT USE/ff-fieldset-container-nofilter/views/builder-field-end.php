<div class="frm_fieldset_preview frm_fieldset_end_preview">
	...
	<div class="frm_fieldset_info">
		<strong><?php echo esc_html__( 'Fieldset End', 'ff-fieldset-container-nofilter' ); ?></strong>
		...
		<div class="frm_fieldset_instruction">
			<?php echo esc_html__( 'This closes the fieldset. All fields between Start and End will be grouped.', 'ff-fieldset-container-nofilter' ); ?>
		</div>
	</div>
</div>
