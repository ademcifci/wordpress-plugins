<div class="frm_fieldset_preview frm_fieldset_start_preview">
	...
	<div class="frm_fieldset_info">
		<strong><?php echo esc_html__( 'Fieldset Start', 'ff-fieldset-container-nofilter' ); ?></strong>
		<?php if ( ! empty( $field['name'] ) ) : ?>
			<div class="frm_fieldset_legend_preview">
				<?php echo esc_html__( 'Legend:', 'ff-fieldset-container-nofilter' ); ?> 
		...
		<div class="frm_fieldset_instruction">
			<?php echo esc_html__( 'Drag fields below this to include them in the fieldset.', 'ff-fieldset-container-nofilter' ); ?>
		</div>
	</div>
</div>
